...
class GameObject(sf.Drawable,Usable):                                       
    ...
    def __init__(self,config_file="data/files/configs/test_game_object.json"):
    ...
    def setPosition(self,x_p,y_p):
        ...
        # if self.solid:
        #    self.x_solid = [x+x_p for x in self.x_p]
        #    self.y_solid = [y+y_p for y in self.y_p]
        #if self.transparent:
...
class Level(sf.Drawable):                                                   
    ...
    def __init__(self, config_file="data/files/levels/test_level.json"):
        ...
        for g_object in self.data['game_objects']:
            self.game_objects.append(GameObject(g_object))
